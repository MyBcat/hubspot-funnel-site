...
const channelIcons: Record<string, React.ReactNode> = {
  ...
  LinkedIn: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-1.814a4.5 4.5 0 00-6.364-6.364L4.34 8.636a4.5 4.5 0 006.364 6.364l1.757-1.757" />
    </svg>
  ),
  Mail: (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {activities.map((activity, i) => (
        <div key={i} className="relative flex gap-4">
          ...
          <div className="flex flex-col items-center">
            <div
              className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0 z-10"
          ...
          <div className="pb-6 flex-1">
            <div className="flex items-center gap-2 mb-1">
              <h4 className="font-semibold text-white text-sm">{activity.step}</h4>
              {activity.channel && (
                <span className="flex items-center gap-1 text-xs px-2 py-0.5 rounded bg-gray-800 text-gray-400">
                  {channelIcons[activity.channel] || null}
                  {activity.channel}
                </span>
              )}
            </div>
